<div class="pop-row">
	<div class="col-md-8 pd-rl">
		<div class="mainbox">
			...
			<?php if (!empty($hasilsearch)): ?>
				<?php foreach ($hasilsearch as $sdf ): ?>
					<div class="col-md-12 col-sm-12 col-xs-12 pd-rl">
						<div class="media udfpublishermedia">
							...
							<div class="media-body">
								<div class="box">
									<div class="countsaranfilm"><?php echo $sdf->filmview; ?> - Menonton ini.</div>
				...
				<?php endforeach ?>
			<?php else: ?>
				<div class="alert alert-danger tengah marb bts-ats"><i class="fa fa-warning"></i> <b><i>Mohon Maaf pencarian tidak di temukan!!</i></b></div>
			<?php endif ?>
