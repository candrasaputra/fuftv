<div class="main-row">
	<div class="fuftvheader pd-rl">
		<div class="post-tags hidden-sm" style="margin-bottom:7px; margin-top:0px;"><i class="fa fa-trophy"></i> FILM DENGAN VIEWER TERBANYAK</div>
		<div class="col-md-12 noncountviewerboxsm tengah pd-rl visible-sm" style="margin-bottom:7px; margin-top:3.5px;"><i class="fa fa-trophy"></i> VIEWER TERBANYAK</div>
		<!--begin-->
		<div class="hidden-xs"> <!--tampilan besar START-->
			<?php foreach ($postertop as $ptsp ): ?>
				<article class="col-md-2 col-sm-4 col-xs-4 pd-rl">
		...
		<div class="mainbox">
			<div class="col-md-12 paddingnone">
				<div class="post-tags hidden-sm" style="margin-top:0px;"><i class="fa fa-coffee"></i> DISARANKAN</div>
				<div class="col-md-12 noncountviewerboxsm tengah pd-rl visible-sm"><i class="fa fa-coffee"></i> DISARANKAN</div>
				<?php if (!empty($disarankan)): ?>
					<?php foreach ($disarankan as $reqeps ): ?>
						<div class="hidden-xs">
							<article class="col-md-2 col-sm-12 col-xs-12 pd-rl2">
								...
								<a href="<?php echo base_url('post/'.$reqeps->epsalias); ?>">
									<h3 class="fuftv-post-ttl hidden-sm hidden-xs" title="<?php echo $reqeps->jdlfilm ;?> <?php echo $reqeps->jdleps ;?> Subtitle Indonesia">
									...
									<h3 class="fuftv-post-ttlsm visible-sm" title="<?php echo $reqeps->jdlfilm ;?> <?php echo $reqeps->jdleps ;?> Subtitle Indonesia">
									<?php $jdlfilm = $reqeps->jdlfilm; echo character_limiter($jdlfilm, 12);?> <?php $jdleps = $reqeps->jdleps; $subs = "Subtitle Indonesia"; $spc = " "; echo character_limiter($jdleps.$spc.$subs, 29);?>
									</h3>
								</a>
			...
			<?php if ($this->main_m->count_film_by_kategori($kat->idkategori) != 0): ?>
				<div class="mainbox">
					<a href="<?php echo base_url(); ?>mainpage_c/kategori/<?php echo $kat->katalias ?>">
						<div class="noncountviewerbox pd-rl hidden-sm">
						...
						<div class="col-md-12 noncountviewerboxsm tengah pd-rl visible-sm"><i class="fa fa-tags"></i><?php echo $kat->jdlkategori; ?></div>
					</a>
						...
						<div class="hidden-xs">
							<article class="col-md-2 col-sm-12 col-xs-12 pd-rl2">
								...
								<a href="<?php echo base_url('post/'.$epskat->alias); ?>">
									<h3 class="fuftv-post-ttl hidden-sm hidden-xs" title="<?php echo $epskat->jdlfilm ;?> <?php echo $epskat->jdleps ;?> Subtitle Indonesia">
									...
									<h3 class="fuftv-post-ttlsm visible-sm" title="<?php echo $epskat->jdlfilm ;?> <?php echo $epskat->jdleps ;?> Subtitle Indonesia">
									<?php $jdlfilm = $epskat->jdlfilm; echo character_limiter($jdlfilm, 12);?> <?php $jdleps = $epskat->jdleps; $subs = "Subtitle Indonesia"; $spc = " "; echo character_limiter($jdleps.$spc.$subs, 29);?>
									</h3>
								</a>
								<div class="fuftv-post-dec">oleh : 
		...
		<div class="main-post">
			<div class="col-md-12 paddingnone">
				<div class="post-tags hidden-sm"><i class="fa fa-pencil-square"></i> UPDATE-AN TERAKHIR</div>
				<div class="col-md-12 noncountviewerboxsm tengah pd-rl visible-sm"><i class="fa fa-pencil-square"></i> UPDATE-AN TERAKHIR</div>
